...
// Test_Day_17_Part1 tests the day 17 solver for part 1
func Test_Day_17_Part1(t *testing.T) {
	testCases := []struct {
		name          string
...
// Test_Day_17_Part2 tests the day 17 solver for part 2
func Test_Day_17_Part2(t *testing.T) {
	testCases := []struct {
		name          string
		input         config.InputType
		expectedValue string
