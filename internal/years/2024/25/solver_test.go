...
// Test_Day_25_Part1 tests the day 25 solver for part 1
func Test_Day_25_Part1(t *testing.T) {
	testCases := []struct {
		name          string
		...
		{"Real", config.RealInput{}, "2978", nil},
	}
...
// Benchmark_Day_25_Part1 benchmarks the day 25 solver for part 1
func Benchmark_Day_25_Part1(b *testing.B) {
...
// Test_Day_25_Part2 tests the day 25 solver for part 2
func Test_Day_25_Part2(t *testing.T) {
	testCases := []struct {
		name          string
		input         config.InputType
		expectedValue string
...
// Benchmark_Day_25_Part2 benchmarks the day 25 solver for part 2
func Benchmark_Day_25_Part2(b *testing.B) {
