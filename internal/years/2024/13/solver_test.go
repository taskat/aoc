...
// Test_Day_13_Part1 tests the day 13 solver for part 1
func Test_Day_13_Part1(t *testing.T) {
	testCases := []struct {
		name          string
		...
		{"Test 1", config.TestInput(1), "480", nil},
		{"Real", config.RealInput{}, "32041", nil},
	}
...
// Benchmark_Day_13_Part1 benchmarks the day 13 solver for part 1
func Benchmark_Day_13_Part1(b *testing.B) {
...
// Test_Day_13_Part2 tests the day 13 solver for part 2
func Test_Day_13_Part2(t *testing.T) {
	testCases := []struct {
		name          string
		input         config.InputType
		expectedValue string
		...
		{"Test 1", config.TestInput(1), "875318608908", nil},
		{"Real", config.RealInput{}, "95843948914827", nil},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
...
// Benchmark_Day_13_Part2 benchmarks the day 13 solver for part 2
func Benchmark_Day_13_Part2(b *testing.B) {
