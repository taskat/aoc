...
// Test_Day_11_Part1 tests the day 11 solver for part 1
func Test_Day_11_Part1(t *testing.T) {
	testCases := []struct {
		name          string
		...
		{"Test 1", config.TestInput(1), "55312", nil},
		{"Real", config.RealInput{}, "220999", nil},
	}
...
// Benchmark_Day_11_Part1 benchmarks the day 11 solver for part 1
func Benchmark_Day_11_Part1(b *testing.B) {
...
// Test_Day_11_Part2 tests the day 11 solver for part 2
func Test_Day_11_Part2(t *testing.T) {
	testCases := []struct {
		name          string
		input         config.InputType
		expectedValue string
		...
		{"Test 1", config.TestInput(1), "65601038650482", nil},
		{"Real", config.RealInput{}, "261936432123724", nil},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
...
// Benchmark_Day_11_Part2 benchmarks the day 11 solver for part 2
func Benchmark_Day_11_Part2(b *testing.B) {
