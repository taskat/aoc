...
// Test_Day_06_Part1 tests the day 06 solver for part 1
func Test_Day_06_Part1(t *testing.T) {
	testCases := []struct {
		name          string
		...
		{"Test 1", config.TestInput(1), "4277556", nil},
		{"Real", config.RealInput{}, "6725216329103", nil},
	}
...
// Benchmark_Day_06_Part1 benchmarks the day 06 solver for part 1
func Benchmark_Day_06_Part1(b *testing.B) {
...
// Test_Day_06_Part2 tests the day 06 solver for part 2
func Test_Day_06_Part2(t *testing.T) {
	testCases := []struct {
		name          string
		input         config.InputType
		expectedValue string
		...
		{"Test 1", config.TestInput(1), "3263827", nil},
		{"Real", config.RealInput{}, "10600728112865", nil},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
...
// Benchmark_Day_06_Part2 benchmarks the day 06 solver for part 2
func Benchmark_Day_06_Part2(b *testing.B) {
